  ...
  let s:guishade0 = "#171511"
  let s:guishade1 = "#38362e"
  let s:guishade2 = "#59584b"
  let s:guishade3 = "#7a7968"
  let s:guishade4 = "#9b9a86"
  let s:guishade5 = "#bcbba3"
  let s:guishade6 = "#ddddc0"
  let s:guishade7 = "#fefedd"
  let s:guiaccent0 = "#ff4050"
  let s:guiaccent1 = "#f2ab71"
  let s:guiaccent2 = "#ffcf86"
  let s:guiaccent3 = "#81a559"
  let s:guiaccent4 = "#208490"
  let s:guiaccent5 = "#1a9ba6"
  let s:guiaccent6 = "#c65967"
  let s:guiaccent7 = "#8e5252"
