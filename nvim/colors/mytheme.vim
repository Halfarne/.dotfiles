  ...
  let s:guishade0 = "#1e1205"
  let s:guishade1 = "#3e3424"
  let s:guishade2 = "#5e5543"
  let s:guishade3 = "#7e7762"
  let s:guishade4 = "#807850"
  let s:guishade5 = "#6dd7e3"
  let s:guishade6 = "#dedcbe"
  let s:guishade7 = "#fefedd"
  let s:guiaccent0 = "#fe192c"
  let s:guiaccent1 = "#f1925b"
  let s:guiaccent2 = "#ffcb52"
  let s:guiaccent3 = "#6ecd38"
  let s:guiaccent4 = "#906920"
  let s:guiaccent5 = "#aa4d33"
  let s:guiaccent6 = "#c65967"
  let s:guiaccent7 = "#ff223d"
