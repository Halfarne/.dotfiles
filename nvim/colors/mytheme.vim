  ...
  let s:guishade5 = "#f24b66"
  let s:guishade6 = "#dedcbe"
  let s:guishade7 = "#fefedd"
  let s:guiaccent0 = "#ff223d"
  let s:guiaccent1 = "#fe192c"
  let s:guiaccent2 = "#81b81c"""""#ffcb52"
  let s:guiaccent3 = "#f5c4ba"
  let s:guiaccent4 = "#ffcb52"
  let s:guiaccent5 = "#1a9ba6"
  let s:guiaccent6 = "#c65967"
  let s:guiaccent7 = "#ff2256"
